...
parser.add_argument('dataset', metavar='hiknn', help='name of the dataset')
parser.add_argument(
    '--root-path',
    type=str,
    default='data/hiknn',
...
parser.add_argument('--extra-tag', type=str, default='hiknn')
parser.add_argument(
...
if __name__ == '__main__':
    ...
    elif args.dataset in ('hiknn','hiknn_mv'):
        scenenn_data_prep(
            root_path=args.root_path,
            info_prefix=args.extra_tag,
            out_dir=args.out_dir,
